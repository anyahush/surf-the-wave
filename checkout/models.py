...
class Order(models.Model):
    ...
    def update_total(self):
        ...
        """
        # Updating total including delivery charges used from Boutique Ado
    ...
    def save(self, *args, **kwargs):
        """
        Override the original save method to set order
...
class OrderLineItem(models.Model):
    """ Model for any individual item in an order """
